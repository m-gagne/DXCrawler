...
module.exports.check_markup_elements = [ 'div', 'canvas', 'a', 'p', 'h1', 'h2', 'h3', 'h4', 'ol', 'ul', 'li', 'table', 'tr', 'th', 'td', 'img', 'span', 'iframe', 'form', 'input', 'textarea', 'button', 'video', 'audio' ];
module.exports.check_markup_threshold = 0.9;
