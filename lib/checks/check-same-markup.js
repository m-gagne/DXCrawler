...
var check = function (website) {
    ...
    if (isExcluded(website.originalUrl)) {
        var result = {
            ...
            passed: true,
            excluded: true,
            data: 'The site was excluded for this test.'
        };
                                    ...
                                    getBody(response2, body2)
                                        .then(function (r2) {
                                            ...
                                            var result = {
                                                ...
                                                data: compareResults2.passed ? compareResults.results : "The HTML markup for this site presents differences after multiple requests."
                                            };
