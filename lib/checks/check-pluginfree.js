...
if (fs.exists('./check-pluginfree.json'))
    options = require('./check-pluginfree.json');
...
var initiate = function (website) {
    ...
    cvlist.getList().then(function (list) {
            ...
            // checks activex
            if (resultWebsite && resultWebsite.featureSwitch && resultWebsite.featureSwitch === "requiresActiveX:true") {
                test.passed = false;
                test.data = {activex: true, cvlist: true};
        } else {
