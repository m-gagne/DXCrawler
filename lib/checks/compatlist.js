...
var compatListUrlGDR = "http://cvlist.ie.microsoft.com/0315000/1426178821/iecompatviewlist.xml",
    compatListUrlSDR = "http://cvlist.ie.microsoft.com/0315000/1426178821/iecompatviewlist.xml",
...
function downloadCVlist(ieversion) {
    ...
    cvListCache.get("List", function (err, value) {
        if (value == undefined) {
            request(cvlistUrl, function (error, response, body) {
                if (!error && response.statusCode === 200) {
                    cvListCache.set("List", body);
